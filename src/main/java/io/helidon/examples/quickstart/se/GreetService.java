...
public class GreetService implements Service {
    ...
    GreetService(Config config) {
        greeting.set(config.get("app.greeting").asString().orElse("Hello"));
        version.set(config.get("app.version").asString().orElse("0.1"));
    }
    ...
    private void sendResponse(ServerResponse response, String name) {
        ...
        String msg = "Version " + version.get() + " " + greeting.get() + " " + name;
